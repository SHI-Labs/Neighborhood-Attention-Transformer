...
def dinat_mini(pretrained=False, **kwargs):
    model = DiNAT(depths=[3, 4, 6, 5], num_heads=[2, 4, 8, 16], embed_dim=64, mlp_ratio=3,
                  drop_path_rate=0.2,
                  kernel_size=7,
                  dilations=[
                      [1, 8, 1],
...
def dinat_tiny(pretrained=False, **kwargs):
    model = DiNAT(depths=[3, 4, 18, 5], num_heads=[2, 4, 8, 16], embed_dim=64, mlp_ratio=3,
                  drop_path_rate=0.2,
                  kernel_size=7,
                  dilations=[
                      [1, 8, 1],
...
def dinat_small(pretrained=False, **kwargs):
    model = DiNAT(depths=[3, 4, 18, 5], num_heads=[3, 6, 12, 24], embed_dim=96, mlp_ratio=2,
                  drop_path_rate=0.3,
                  kernel_size=7,
                  dilations=[
                      [1, 8, 1],
...
def dinat_base(pretrained=False, **kwargs):
    model = DiNAT(depths=[3, 4, 18, 5], num_heads=[4, 8, 16, 32], embed_dim=128, mlp_ratio=2,
                  drop_path_rate=0.5,
                  kernel_size=7,
                  dilations=[
                      [1, 8, 1],
...
def dinat_large(pretrained=False, **kwargs):
    model = DiNAT(depths=[3, 4, 18, 5], num_heads=[4, 8, 16, 32], embed_dim=192, mlp_ratio=2,
                  drop_path_rate=0.35,
                  kernel_size=7,
                  dilations=[
                      [1, 8, 1],
